...
class TestEnvironmentSetup:
    ...
    def test_environment_vars_readable(self):
...
class TestConfigurationLogic:
    ...
    def test_mode_defaults_to_hs512(self):
    ...
    def test_mode_detects_eddsa_for_producer_with_private_key(self):
    ...
    def test_mode_detects_eddsa_for_consumer_with_public_key(self):
    ...
    def test_mode_producer_ignores_public_key(self):
    ...
    def test_mode_consumer_ignores_private_key(self):
    ...
    def test_common_returns_defaults(self):
    ...
    def test_common_reads_from_env(self):
    ...
    def test_secret_name_indirection_detection(self):
    ...
    def test_private_key_name_indirection_detection(self):
    ...
    def test_public_key_name_indirection_detection(self):
